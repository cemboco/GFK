                ...
                {activeTab === 'about' ? (
                  ...
                  >
                    ...
                    <div className="bg-white/80 backdrop-blur-sm shadow-xl rounded-2xl p-8 mb-16">
                      ...
                      <AnimatePresence>
                        {(liveOutput || output) && (
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <h3 className="text-xl font-semibold text-gray-900">GFK-Formulierung:</h3>
                              {output && !isTyping && (
                                <motion.button
                                  whileHover={{ scale: 1.05 }}
                                  whileTap={{ scale: 0.95 }}
                                ...
                                >
                                  ...
                                  {user ? 'GFK-Coach fragen' : 'Coach (Anmeldung erforderlich)'}
                                </motion.button>
                              )}
                            </div>
                              ...
                              >
                                <p className="text-gray-800 leading-relaxed mb-4">
                                  ...
                                  {isTyping && liveOutput ? (
                                    <span className="inline-block">
                                      {liveOutput.observation}
                                      {liveOutput.observation && <span className="animate-pulse">|</span>}
                                    </span>
                                  ) : (
                                ...
                                <p className="text-gray-800 leading-relaxed mb-4">
                                  ...
                                  {isTyping && liveOutput ? (
                                    <span className="inline-block">
                                      {liveOutput.feeling}
                                      {liveOutput.observation && !liveOutput.feeling && <span className="animate-pulse">|</span>}
                                    </span>
                                  ) : (
                                ...
                                <p className="text-gray-800 leading-relaxed mb-4">
                                  ...
                                  {isTyping && liveOutput ? (
                                    <span className="inline-block">
                                      {liveOutput.need}
                                      {liveOutput.feeling && !liveOutput.need && <span className="animate-pulse">|</span>}
                                    </span>
                                  ) : (
                                ...
                                <p className="text-gray-800 leading-relaxed">
                                  ...
                                  {isTyping && liveOutput ? (
                                    <span className="inline-block">
                                      {liveOutput.request}
                                      {liveOutput.need && !liveOutput.request && <span className="animate-pulse">|</span>}
                                    </span>
                                  ) : (
                    ...
                    >
                      ...
                      <span className="font-medium text-purple-600">
                        64 Nutzer haben bereits getestet
                      </span>
                    </motion.div>
                  </motion.div>
                )}
