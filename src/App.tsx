          ...
          <div className="max-w-7xl mx-auto px-4 text-center space-y-4">
            ...
            <div className="pt-4 border-t border-gray-200">
              ...
              <p className="text-xs text-gray-400 mt-1">
                Version 1.6.4 - Kompakteres Testimonials-Design
              </p>
        ...
        {showVersionInfo && (
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-sm font-medium">Beta Version 1.6.4</span>
                <p className="text-xs text-purple-100">Kompakteres Testimonials-Design</p>
              </div>
            </div>
            <button 
