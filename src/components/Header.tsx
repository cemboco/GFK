        ...
        <div className="flex items-center justify-between">
          ...
          >
            <Link to="/" className="flex items-center space-x-3">
              <div className="w-[42px] h-[42px] rounded-xl overflow-hidden flex items-center justify-center bg-white">
                <img src="/logo.png" alt="GFKCoach Logo" className="w-[42px] h-[42px] object-contain" />
              </div>
              <div>
